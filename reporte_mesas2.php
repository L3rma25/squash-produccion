...
include("conexion.php");
		...
		$sql= "SELECT * FROM detalle_mesas WHERE fecha='$fecha_inicial' ";
		...
		echo'<table class="table table-bordered">
			...
			else
			{
				...
				$sql_consulta= "SELECT * FROM detalle_mesas,mesas WHERE fecha='$fecha_inicial' AND detalle_mesas.id_mesa=mesas.id_mesa";
			   //echo $sql_consulta;
			   ...
			   while ($fila_consulta =  mysqli_fetch_assoc($result_consulta)) {
				...
				$nombre_mesa=$fila_consulta['nombre_mesa'];
				
				$total=$total+$costo;	
				
				
				echo"<tbody><tr>
                                <td align='right'  width='80'>$nombre_mesa</td>
